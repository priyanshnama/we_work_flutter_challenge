...
class CustomShapeClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.quadraticBezierTo(size.width / 2 + topBarOffset, topHeight,
        size.width / 2 + topBarOffset, topHeight / 2);
    path.quadraticBezierTo(size.width / 2 + topBarOffset, 0,
        (size.width + topHeight) / 2 + topBarOffset, 0);
